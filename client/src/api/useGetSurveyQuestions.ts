...
export default function useGetSurveyQuestions(): GetSurveyQuestion {

    const api = new Api();

    const getSurveyQuestions = function (id: string): Promise<void | SurveyQuestion> {

        return api.api.v1SurveyQuestionsDetail(id)
